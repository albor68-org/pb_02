...
int main() {
    ...
    // Проверка, что были введены оценки за самостоятельные работы
    if (count == 0) {
        cout << "Ошибка: не введены оценки за самостоятельные работы!" << endl;
        return 1;
    }

    // Выводим сообщение об итоговой оценке и саму оценку
