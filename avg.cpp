...
int main () {
	...
	cout << "Введите свои оценки за контрольную работу и экзамен: " << endl;
	double midterm, final;
	cin >> midterm >> final;

	// Запрос оценок за самостоятельные работы
	сout << "Введите оценки за самостоятельные работы, после завершения списка введите команду завершения ввода (Ctrl-D): ";
	...
	cout << name << ", ваша итоговая оценка: " << setprecision(3)
	     << 0.2 * minterm + 0.4 * final + 0.4 * sum / count
